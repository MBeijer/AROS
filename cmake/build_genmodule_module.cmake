...
function(_aros_read_generated_makefile_value pattern out_var)
  file(STRINGS "${MODULE_GENERATED_DIR}/Makefile.${MODULE_NAME}${MODULE_TYPE}" _value_line REGEX "^${pattern}[ \t]*\\+=")
  if(_value_line)
    string(REGEX REPLACE "^${pattern}[ \t]*\\+=[ \t]*" "" _value "${_value_line}")
    string(STRIP "${_value}" _value)
    separate_arguments(_value NATIVE_COMMAND "${_value}")
    set(${out_var} "${_value}" PARENT_SCOPE)
  else()
    set(${out_var} "" PARENT_SCOPE)
  endif()
